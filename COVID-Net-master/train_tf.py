...
parser.add_argument('--trainfile', default='train_split_v3.txt', type=str, help='Name of train file')
parser.add_argument('--testfile', default='test_split_v3.txt', type=str, help='Name of test file')
